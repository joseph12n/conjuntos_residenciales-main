                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="mt">
                        <a class="active" href="?c=Dashboard">
                            <i class="fas fa-home"></i> <!-- Icono actualizado para Dashboard -->
                    ...
                    <li class="sub-menu">
                        <a href="javascript:;">
                            <i class="fas fa-calendar-alt"></i> <!-- Icono actualizado para Reservas -->
                            <span>Reservas</span>
                        </a>
                        <ul class="sub">
                    ...
                    <li class="sub-menu">
                        <a href="javascript:;">
                            <i class="fas fa-info-circle"></i> <!-- Icono actualizado para Acerca de -->
                            <span>Acerca de</span>
                        </a>
                        <ul class="sub">
                            <li><a href="?c=salon">Salón comunal</a></li>
                            <li><a href="?c=quiosco">Quiosco</a></li>
                        </ul>
                    </li>
