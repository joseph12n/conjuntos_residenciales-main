...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-08-2024 a las 02:38:06
...
INSERT INTO `house` (`cod_house`, `house_name`) VALUES
(1, 'CASA UNO'),
(2, 'CASA DOS'),
(3, 'CASA TRES'),
(4, 'CASA CUATRO'),
...
--
ALTER TABLE `house`
  MODIFY `cod_house` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
