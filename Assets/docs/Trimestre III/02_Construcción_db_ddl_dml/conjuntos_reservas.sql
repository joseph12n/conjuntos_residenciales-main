...
-- -----------------------------------------------------
-- Table `conjuntos_reservas`.`VEHICLE_TYPE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `conjuntos_reservas`.`VEHICLE_TYPE` (
...
CREATE TABLE IF NOT EXISTS `conjuntos_reservas`.`VEHICLE` (
  ...
  CONSTRAINT `FK_vehicle_type`
    ...
    REFERENCES `conjuntos_reservas`.`VEHICLE_TYPE` (`cod_type`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
