...
CREATE TABLE IF NOT EXISTS `conjuntos_reservas`.`USERS` (
  ...
  INDEX `FK_house_cod_idx` (`cod_house` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `conjuntos_reservas`.`PLACES` (
  ...
  INDEX `FK_category_idx` (`cod_category` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `conjuntos_reservas`.`LIST_PLACES` (
  ...
  INDEX `FK_places_idx` (`cod_booking` ASC) VISIBLE,
  INDEX `FK_places_idx1` (`cod_place` ASC) VISIBLE,
  CONSTRAINT `FK_list`
...
CREATE TABLE IF NOT EXISTS `conjuntos_reservas`.`VEHICLE` (
  ...
  INDEX `FK_vehicle_type_idx` (`cod_type` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `conjuntos_reservas`.`PARKING` (
  ...
  INDEX `FK_vehicle_idx` (`cod_vehicle` ASC) VISIBLE,
